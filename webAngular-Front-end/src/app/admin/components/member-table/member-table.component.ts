...
export class MemberTableComponent implements OnChanges, AfterViewInit {
  ...
  displayedColumns: string[] = ['avatar', 'nom', 'prenom', 'cin','nomEquipe', 'profil']; // Translated column names to English
  ...
  viewProfile(member: Member): void { // Renamed 'voirProfil' to 'viewProfile' and 'employe' to 'employee' for consistency
    this.router.navigateByUrl(`admin/member/${member.id}`); // Changed 'chef/employe' to 'manager/employee' for consistency
  }
}
