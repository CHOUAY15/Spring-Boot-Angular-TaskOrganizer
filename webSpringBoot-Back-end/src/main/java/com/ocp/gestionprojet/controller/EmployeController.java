...
public class EmployeController {
    ...
    public ResponseEntity<EmployeDto> addEmployeToEquipe(@Valid @RequestBody EmployeDto employeDto, @PathVariable("eqpId") Integer eqpId) throws EntityNotFoundException {
        EmployeDto employeSavedDto = employeService.addEmployeToEquipe(employeDto,eqpId);
    ...
    //update
    @PutMapping("")
    public ResponseEntity <EmployeDto> updateEmploye(@Valid @RequestBody EmployeDto employeDto) throws EntityNotFoundException{
