...
public class ChefDequipeController {
    ...
    // public ResponseEntity<ChefDequipeDto> addChefToDepartement(@Valid
    // @RequestBody ChefDequipeDto chefDto,
    // @PathVariable("deptId") Integer deptId) throws EntityNotFoundException {
    // ChefDequipeDto savedChefDto =
    // chefDequipeService.addChefToDepartement(chefDto, deptId);
