...
public class EquipeController {
    ...
    public ResponseEntity<EquipeDto> addEquipeToDeparatement(@Valid @RequestBody EquipeRequestDto equipeDto,
    ...
    // update
    @PutMapping("/id/{id}")
    public ResponseEntity<EquipeDto> updateEquipe(@PathVariable("id") Integer id,@Valid @RequestBody EquipeRequestDto equipeDto)
            throws EntityNotFoundException {
        EquipeDto updatedEquipeDto = equipeService.update(equipeDto,id);
    ...
    // delete
    @DeleteMapping("id/{id}")
    public ResponseEntity<?> deleteEquipe(@PathVariable("id") Integer id) {
    ...
    // public ResponseEntity<EquipeDto> addEquipeToChef(@Valid @RequestBody
    // EquipeDto equipeDto,
    ...
    // public ResponseEntity<List<EquipeDto>>
    // getEquipesByDepartmentId(@PathVariable("deptId") Integer deptId) {
    // return new ResponseEntity<>(equipeService.findEquipesByDepartmentId(deptId),
    // HttpStatus.OK);
    // }

    // getOne
    // @GetMapping("/id/{id}")
    // public ResponseEntity<EquipeDto> getEmploye(@PathVariable("id") Integer id)
    // throws EntityNotFoundException {
